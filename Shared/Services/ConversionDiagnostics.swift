...
/// On-device record of how someone met Posture Pro before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.posture", category: "Conversion")
    ...
    static let suiteName = "group.com.jackwallner.posture"
    ...
    private static let impressionPrefix = "posture_"
