...
enum PostureTipService {
    private static let tips: [PostureTip] = [
        ...
        PostureTip(text: "Your elbows should rest at 90 degrees when typing — adjust chair height if not.", category: .ergonomics),
        ...
        PostureTip(text: "Set a timer to check your posture — awareness is the first step to improvement.", category: .habit),
        ...
        // Awareness
        PostureTip(text: "Your posture often mirrors your mood — stand tall to feel more confident.", category: .awareness),
        PostureTip(text: "Deep breathing expands your ribcage — inhale tall, exhale relaxed.", category: .awareness),
